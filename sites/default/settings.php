 ...
 * @endcode
 */
$settings['hash_salt'] = 'u1VxlYdVuyghs0cQfdLfOR_QTaNKntl3J5vYdeE29eS32a1l3X4lreWTbdcFciYev2ltVKYOMQ';
...
$settings['config_sync_directory'] = 'sites/default/files/config_GyF0XhpL6XMVjmCnfQGjFbmXD8o2SBtDQu81sQjRNai99IwOsUukQGaQCxDl97Pud5EjQDJOjQ/sync';
 if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
   include $app_root . '/' . $site_path . '/settings.local.php';
}